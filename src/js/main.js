...
var AddOrEditCompany = function(id, addOrEdit) {  
...
var PricePlusSubPrice = function(id) {
    if(document.getElementById(id).parentElement.id == 'companies')
        return;
...
var EditCompany = function(id, companyName, price) {
...
var CreateCompany = function(id, name, price, parentId, allPrice) {
